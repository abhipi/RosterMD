    ...
    >
      <Modal.Header closeButton style={{backgroundColor: "rgba(64, 12, 47, 1)", color:"white", borderWidth:"2px", borderColor:"rgb(64, 12, 47)"}}>
        <Modal.Title id="contained-modal-title-vcenter">
          For Institutions&nbsp;&nbsp;<img src={require('../../images/hospital.png')} style={{height:"40px"}}></img>
        </Modal.Title>
      </Modal.Header>
...
{invalid && (<p style={{color:"#FF7D7D"}}>Invalid Credentials</p>)}
      <MDBRow className='mb-4' style={{whiteSpace:"nowrap"}}>
        ...
        <MDBCol className='d-flex justify-content-center'>
        <MDBBtn className='mb-4' style={{height:"40px", maxWidth: "140px", width:"100%", paddingLeft:"10%", paddingRight:"10%", color:"black",backgroundImage: "linear-gradient(135deg, #FBA854 0%, #FBA854 100%)", fontWeight:"590", fontSize:"115%"}} onClick={()=>{navigate("/dashboard")}}>
        Sign in!
      </MDBBtn>
        </MDBCol>
      </MDBRow>
